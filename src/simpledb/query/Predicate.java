...
public class Predicate {
	...
	/**
	 * Calculates the extent to which selecting on the predicate reduces the number
	...
	/**
	 * Returns the subpredicate consisting of terms that apply to the union of the
	...
	/**
	 * Determines if there is a term of the form "F1=F2" where F1 is the specified
