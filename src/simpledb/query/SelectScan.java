...
public class SelectScan implements UpdateScan {
	...
	/**
	 * Move to the next record satisfying the predicate. The method repeatedly calls
	 * next on the underlying scan until a suitable record is found, or the
	 * underlying scan contains no more records.
	 * 
