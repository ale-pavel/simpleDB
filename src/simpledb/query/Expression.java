...
public interface Expression {
	...
	/**
	 * Evaluates the expression with respect to the current record of the specified
	 * scan.
	 * 
	 * @param s the scan
	...
	/**
	 * Determines if all of the fields mentioned in this expression are contained in
