...
public class Term {
	...
	/**
	 * Calculates the extent to which selecting on the term reduces the number of
	...
	/**
	 * Determines if this term is of the form "F=c" where F is the specified field
	...
	/**
	 * Returns true if both of the term's expressions evaluate to the same constant,
