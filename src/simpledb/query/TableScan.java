...
public class TableScan implements UpdateScan {
	 ...
	 * examined to determine the field's type. If INTEGER, then the record file's
	 * getInt method is called; otherwise, the getString method is called.
	 * 
	...
	/**
	 * Sets the value of the specified field, as a Constant. The schema is examined
	 * to determine the field's type. If INTEGER, then the record file's setInt
	 * method is called; otherwise, the setString method is called.
	 * 
