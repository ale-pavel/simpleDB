...
public class SimpleDriver extends DriverAdapter {
	...
	/**
	 * Connects to the SimpleDB server on the specified host. The method retrieves
	 * the RemoteDriver stub from the RMI registry on the specified host. It then
	 * calls the connect method on that stub, which in turn creates a new connection
	 * and returns the RemoteConnection stub for it. This stub is wrapped in a
	 * SimpleConnection object and is returned.
	 * <P>
