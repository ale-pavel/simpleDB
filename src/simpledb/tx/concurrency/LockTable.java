...
class LockTable {
	...
	/**
	 * Grants an SLock on the specified block. If an XLock exists when the method is
	...
	/**
	 * Grants an XLock on the specified block. If a lock of any type exists when the
	...
	/**
	 * Releases a lock on the specified block. If this lock is the last lock on that
