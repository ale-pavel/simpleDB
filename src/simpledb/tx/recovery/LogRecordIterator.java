...
class LogRecordIterator implements Iterator<LogRecord> {
	...
	/**
	 * Constructs a log record from the values in the current basic log record. The
	 * method first reads an integer, which denotes the type of the log record.
	 * Based on that type, the method calls the appropriate LogRecord constructor to
