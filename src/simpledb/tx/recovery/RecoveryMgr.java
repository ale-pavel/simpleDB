...
public class RecoveryMgr {
	...
	/**
	 * Writes a setint record to the log, and returns its lsn. Updates to temporary
	 * files are not logged; instead, a "dummy" negative lsn is returned.
	 * 
	 ...
	 * temporary files are not logged; instead, a "dummy" negative lsn is returned.
	 * 
	 * @param buff   the buffer containing the page
	 * @param offset the offset of the value in the page
	 * @param newval the value to be written
	 ...
	 * calls undo() on that record. The method stops when it encounters a CHECKPOINT
