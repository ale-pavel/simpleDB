...
public class IndexInfo {
	...
	/**
	 * Returns the estimated number of records having a search key. This value is
	 * the same as doing a select query; that is, it is the number of records in the
	...
	/**
	 * Returns the distinct values for a specified field in the underlying table, or
	...
	/**
	 * Returns the schema of the index records. The schema consists of the dataRID
	 ...
	 * indexed field is obtained via the table's metadata.
	 * 
