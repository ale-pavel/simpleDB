...
public class MaterializePlan implements Plan {
	...
	/**
	 * This method loops through the underlying query, copying its output records
	 * into a temporary table. It then returns a table scan for that table.
	 * 
	...
	/**
	 * Returns the number of records in the materialized table, which is the same as
	 * in the underlying plan.
	 * 
