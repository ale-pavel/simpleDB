...
public class GroupByScan implements Scan {
	...
	/**
	 * Positions the scan before the first group. Internally, the underlying scan is
	 ...
	 * field, then its value can be obtained from the saved group value. Otherwise,
	 * the value is obtained from the appropriate aggregation function.
	 * 
	...
	/**
	 * Gets the integer value of the specified field. If the field is a group field,
	...
	/**
	 * Gets the string value of the specified field. If the field is a group field,
	 * then its value can be obtained from the saved group value. Otherwise, the
	 * value is obtained from the appropriate aggregation function.
	 * 
	 * @see simpledb.query.Scan#getVal(java.lang.String)
	...
	/*
	 * Returns true if the specified field is either a grouping field or created by
