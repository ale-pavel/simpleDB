...
public class GroupByPlan implements Plan {
	...
	/**
	 * Creates a groupby plan for the underlying query. The grouping is determined
	 * by the specified collection of group fields, and the aggregation is computed
	 * by the specified collection of aggregation functions.
	 * 
	...
	/**
	 * Returns the number of blocks required to compute the aggregation, which is
	 * one pass through the sorted table. It does <i>not</i> include the one-time
	...
	/**
	 * Returns the number of distinct values for the specified field. If the field
	 * is a grouping field, then the number of distinct values is the same as in the
