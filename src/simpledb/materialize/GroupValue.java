...
public class GroupValue {
	...
	/**
	 * Creates a new group value, given the specified scan and list of fields. The
	 * values in the current record of each field are stored.
	 * 
	 * @param s      a scan
	...
	/**
	 * The hashcode of a GroupValue object is the sum of the hashcodes of its field
	 * values.
	 * 
