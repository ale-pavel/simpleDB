...
public class MultiBufferProductScan implements Scan {
	...
	/**
	 * Moves to the next record in the current scan. If there are no more records in
	 * the current chunk, then move to the next LHS record and the beginning of that
	 * chunk. If there are no more LHS records, then move to the next chunk and
	 * begin again.
	 * 
	...
	/**
	 * Returns the integer value of the specified field. The value is obtained from
	 * whichever scan contains the field.
	 * 
