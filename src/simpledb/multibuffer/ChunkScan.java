...
public class ChunkScan implements Scan {
	...
	/**
	 * Moves to the next record in the current block of the chunk. If there are no
	 * more records, then make the next block be current. If there are no more
	 * blocks in the chunk, return false.
	 * 
