...
public interface UpdatePlanner {
	...
	/**
	 * Executes the specified insert statement, and returns the number of affected
	 * records.
	 * 
	...
	/**
	 * Executes the specified delete statement, and returns the number of affected
	 * records.
	 * 
	...
	/**
	 * Executes the specified modify statement, and returns the number of affected
	 * records.
	 * 
