...
public class IndexSelectScan implements Scan {
	 ...
	 * next record satisfying the selection constant, and returning false if there
	 * are no more such index records. If there is a next record, the method moves
	 * the tablescan to the corresponding data record.
	 * 
