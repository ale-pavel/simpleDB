...
public class IndexSelectPlan implements Plan {
	...
	/**
	 * Estimates the number of block accesses to compute the index selection, which
	 * is the same as the index traversal cost plus the number of matching data
	 * records.
	 * 
	...
	/**
	 * Estimates the number of output records in the index selection, which is the
	 * same as the number of search key values for the index.
	 * 
