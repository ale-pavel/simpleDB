...
public class IndexJoinScan implements Scan {
	 ...
	 * positioned at its first record, and the index will be positioned before the
	 * first record for the join value.
	 * 
	...
	/**
	 * Moves the scan to the next record. The method moves to the next index record,
	 * if possible. Otherwise, it moves to the next LHS record and the first index
