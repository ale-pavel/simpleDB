...
public class BTreeIndex implements Index {
	 ...
	 * appropriate files for the leaf and directory records, creating them if they
	 * did not exist.
	 * 
	...
	/**
	 * Inserts the specified record into the index. The method first traverses the
	 * directory to find the appropriate leaf page; then it inserts the record into
	 * the leaf. If the insertion causes the leaf to split, then the method calls
	 * insert on the root, passing it the directory entry of the new leaf page. If
	 * the root node splits, then makeNewRoot is called.
	 * 
	...
	/**
	 * Deletes the specified index record. The method first traverses the directory
	 * to find the leaf page containing that record; then it deletes the record from
	 * the page.
	 * 
