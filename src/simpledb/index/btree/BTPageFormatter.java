...
public class BTPageFormatter implements PageFormatter {
	...
	/**
	 * Formats the page by initializing as many index-record slots as possible to
	 * have default values. Each integer field is given a value of 0, and each
	 * string field is given a value of "". The location that indicates the number
	 * of records in the page is also set to 0.
	 * 
