...
public class BTreeLeaf {
	 ...
	 * immediately before the first record having the specified search key (if any).
	 * 
	 ...
	 * previously-specified search key. If the record does not fit in the page, then
	 * the page splits and the method returns the directory entry for the new page;
	 * otherwise, the method returns null. If all of the records in the page have
	 * the same dataval, then the block does not split; instead, all but one of the
