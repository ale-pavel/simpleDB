...
public class BTreePage {
	...
	/**
	 * Calculates the position where the first record having the specified search
	 ...
	 * records of the page starting at the split position are transferred to the new
	 * page.
	 * 
