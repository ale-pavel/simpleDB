...
class RecordFormatter implements PageFormatter {
	...
	/**
	 * Formats the page by allocating as many record slots as possible, given the
	 * record length. Each record slot is assigned a flag of EMPTY. Each integer
	 * field is given a value of 0, and each string field is given a value of "".
	 * 
