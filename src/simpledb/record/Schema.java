...
public class Schema {
	...
	/**
	 * Creates an empty schema. Field information can be added to a schema via the
	 * five addXXX methods.
	 */
	public Schema() {
	}
	...
	/**
	 * Adds a field to the schema having a specified name, type, and length. If the
	 * field type is "integer", then the length value is irrelevant.
	 * 
	...
	/**
	 * Adds a string field to the schema. The length is the conceptual length of the
	 * field. For example, if the field is defined as varchar(8), then its length is
	 * 8.
	 * 
	 * @param fldname the name of the field
	...
	/**
	 * Returns the conceptual length of the specified field. If the field is not a
